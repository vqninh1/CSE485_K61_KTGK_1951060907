            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form action="./add.php" method="post">
                  ...
                  <div class="row mb-3">
                    <label for="txtNamSinh" class="col-sm-2 col-form-label">Năm Sinh(Tuổi)</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                  <label for="txtSomaucannhan" class="col-sm-2 col-form-label">Số máu cần nhận(ml)</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="txtSomaucannhan" name="txtSomaucannhan">
                    </div>
                  </div>
                  <div class="row mb-3">
